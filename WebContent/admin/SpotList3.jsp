...
String totalsql="select count(*) total from shopping_spot";
...
String   sql="select b.* from(select "; 
		...
		sql+=" from shopping_spot s , shopping t ";
...
<div class="container">
	...
	<table class="table1">
		...
		<tr>
			...
			<td><%=rn %></td>
			<td><%=dname %></td>
			<td><a href="tourDetail3.jsp?unq=<%=unq%>"><%=name %></a></td>
			<td><%=addr %></td>
			<td><%=tel %></td>
  ...
  for(int i=1; i<=totalPage; i++){
	  %>
	  <a href="SpotList3.jsp?viewPage=<%=i%>"><%=i %></a>
	  <%
