<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    sql+=" from restaurant_spot s, restaurant t ";//sql작성
...
<script>
		function fn_delete(){
	confirm("정말 삭제하시겠습니까?");
	location="SpotDelete2.jsp?deptno=<%=deptno%>&unq=<%=unq%>";
...
<div class="container">
	...
	<table class="table1">
			...
			<td>이용안내</td>
			<td><a href="useDetail2.jsp?unq=<%=unq %>">link</a>
				<%
				...
				%>
				<a href="useWrite2.jsp?unq=<%=unq %>">추가</a>
				<%}%>
			</td>
			</tr>
			...
			<td>상세정보</td>
			<td><a href="content2.jsp?unq=<%=unq %>">link</a>
			</td>
			</tr>
  ...
  <div class="div2">
        	...
        	onclick="location='SpotModify2.jsp?unq=<%=unq%>'">
