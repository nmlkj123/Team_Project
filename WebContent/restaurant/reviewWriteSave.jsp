...
<%
	...
	int c= stmt.executeUpdate("insert into restaurant_review values(restaurant_review_SEQ.nextval,'"+pid+"','"+memId+"','"+memName+"','"+content+"','"+image+"','"+hashtag+"','"+star+"',sysdate)");

	if(chk.equals("1")){
		
		int i  = stmt.executeUpdate("update restaurant_spot set back=back+1 where unq='"+pid+"'" );
