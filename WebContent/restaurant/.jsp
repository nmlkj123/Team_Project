...
while(rs2.next()){
	...
	ResultSet rs6= stmt2.executeQuery("select count(*) cnt from mylist1 where like_spot="+unq+"");
	rs6.next();
	String like1 =rs6.getString("cnt");
	ResultSet rs7= stmt2.executeQuery("select count(*) cnt from mylist1 where jjim_spot="+unq+"");
	rs7.next();
