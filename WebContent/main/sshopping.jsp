...
ResultSet rs=stmt.executeQuery("select * from(select rownum rn, a.* from( select unq,name,addr,addr2,tel,image from shopping_spot where unq like '%"+q+"%' or name like '%"+q+"%' or addr2 like '%"+q+"%' or hashtag like '%"+q+"%' or  tel like '%"+q+"%' )a ) where rn >= "+startNo+" and rn <="+endNo+"");
