...
<div class="box1 bg">
   <div class="box2">아이디찾기</div>
   <form name="frm" method="post" action="searchId.jsp">
   <div class="box3">
   <table>
         <tr>
         ...
         <tr>
            <input class="input1" type=id name="email" onclick="this.value=''" value="이메일"  maxlength="30"><br>
         </tr>
