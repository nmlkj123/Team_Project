...
<div class="box1 bg">
   ...
   <table>
         <tr>
            <input class="input1" type=id name="id"onclick="this.value=''" value="아이디" maxlength="15"><br>
         </tr>
         
         <tr>
            <input class="input1" type="password" name="pwd" onclick="this.value=''" value="비밀번호"  maxlength="15"><br>
         </tr>
         
         <tr>
            <input class="input3" type="button" name="login" value="로그인"
