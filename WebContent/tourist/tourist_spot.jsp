...
<%String tunq=request.getParameter("tunq"); 
	...
	ResultSet rs= stmt.executeQuery("select * from tourist_spot where unq="+tunq+"");
	rs.next();
	...
	stmt.executeUpdate("update tourist_spot set hit=hit+1 where unq="+tunq+"");
	
	ResultSet rs2= stmt.executeQuery("select count(*) as cnt from tourist_review where pid="+tunq+"");
	rs2.next();
	String rcount=rs2.getString("cnt");
	ResultSet rs3= stmt.executeQuery("select count(*) cnt from mylist where like_spot="+tunq+" and type=1");
	rs3.next();
	String like1 =rs3.getString("cnt");
	ResultSet rs4= stmt.executeQuery("select count(*) cnt from mylist where jjim_spot="+tunq+" and type=1");
	rs4.next();
