...
<%
	...
	int c= stmt.executeUpdate("insert into tourist_review values(TOURIST_REVIEW_SEQ.nextval,'"+pid+"','"+memId+"','"+memName+"','"+content+"','"+image+"','"+hashtag+"','"+star+"',sysdate)");

	if(chk.equals("1")){
		
		int i  = stmt.executeUpdate("update tourist_spot set back=back+1 where unq='"+pid+"'" );
